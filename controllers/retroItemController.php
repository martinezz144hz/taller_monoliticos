...
class retroItemController 
{
    ...
    public function CreateRetroItemSprit(Array $paramters) 
    {
    ...
    public function showAllSprint()
    {
        return $this->sprintModel->getAll();
    }

    public function showAllRetroItem()
    {
        return $this->retroItemModel->getWithSprint();
    }
}
